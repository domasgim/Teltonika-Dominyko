...
static gboolean on_handle_sms (SMSProcessGDBUS *interface, GDBusMethodInvocation *invocation, const gchar *phone_number, const gchar *SMS_message, gpointer user_data) {
    ...
    char *phone_numberr_chopped = phone_numberr + 1;
    ...
    if (SMS_messagee[0] == '1' && strlen(SMS_messagee) == 1) {
        printf("Debug | Option 1\n");
        send_sms(phone_numberr_chopped, msg1);
    } else if (SMS_messagee[0] == '2' && strlen(SMS_messagee) == 1) {
        printf("Debug | Option 2\n");
        send_sms(phone_numberr_chopped, msg2);
    } else if (SMS_messagee[0] == '3' && strlen(SMS_messagee) == 1) {
        printf("Debug | Option 3\n");
        send_sms(phone_numberr_chopped, msg3);
    } else if (SMS_messagee[0] == '4' && strlen(SMS_messagee) == 1) {
        printf("Debug | Option 4\n");
        send_sms(phone_numberr_chopped, msg4);
    }
    printf("========================================================================\n\n\n");
