...
int main(int argc, char *argv[]) {
    ...
    int loop_length = strlen(argv[2]) * 2;
    int msg_length = 0;
    ...
    make_pdu(argv[1], Output, msg_length, alphabet, flash, report, with_udh, udh_data, mode, pdu, validity, replace_msg, system_msg, to_type);
